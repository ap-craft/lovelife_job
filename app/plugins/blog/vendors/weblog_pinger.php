...
class Weblog_Pinger {
    ...
    function ping_weblogs_com_extended($weblog_name, $weblog_url, $changes_url, $rss_url) {
        return $this->ping($this->weblogs_com_server, $this->weblogs_com_port,
            ...
            $weblog_url, $changes_url, $rss_url);
    }
    
	function simplePing($ping_url,$weblog_name,$weblog_url,$changes_url = "",$category = "",$rss_url = ""){
		...
		return $this->ping($url['host'], 80,$url['path'],'weblogUpdates.ping', $weblog_name,$weblog_url, $changes_url, $rss_url);
	}
