...
var WYSIWYG = {
	...
	execCommand: function(n, cmd, value) {
		...
		switch(cmd) {
			...
			// InsertImage
			case "InsertImage": 
				window.open(imagePopupFile + '?' + session_name + '=' + session_id + '&wysiwyg=' + n, 'popup', 'location=0,status=0,scrollbars=0,resizable=0,width=' + imagePopupWidth + ',height=' + imagePopupHeight + ',top=' + popupPosition.top + ',left=' + popupPosition.left).focus();
			break;
